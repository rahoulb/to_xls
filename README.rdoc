...
Alternatively, you can define an `as_xls(options = {})` method on a model. This should return a hash.
...
You can return nested collections within `as_xls`. These are rendered as additional worksheets. The following code will produce a second worksheet called "Tasks" with all users' tasks.
